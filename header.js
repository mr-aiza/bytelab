...
if (!document.querySelector('meta[name="color-scheme"]')) {
  ...
  const DOCK_TABS = [
    { id: "home", href: "index.html", icon: "خانه", label: "خانه", acc: "#4df0c9", match: ["index.html", ""] },
    { id: "portfolio", href: PORTFOLIO_SUBMIT_HREF, icon: "نمونه کار", label: "نمونه‌کار", acc: "#9c7bff", match: [], forceActive: isPortfolioPage },
    { id: "chat", href: "chat.html", icon: "هوش مصنوعی", label: "هوش مصنوعی", acc: "#4df0c9", match: ["chat.html"] },
    { id: "bazaar", href: "https://cafebazaar.ir/app/com.bytelab.app", icon: "دانلود اَپ", label: "دانلود", acc: "#f2c14e", external: true, match: [] }
